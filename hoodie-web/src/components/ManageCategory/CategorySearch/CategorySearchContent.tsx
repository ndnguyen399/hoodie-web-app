 ...
 * 
 * @param props 
 * @returns CategorySearchContent
 */
export const CategorySearchContent: React.FC<PageProps> = props => {
    ...
    return (
        <>
            ...
            <PageContainer
              title={t('label-pageTitleCategorySearch')}
              breadcrumbs={[{ title: t('label-pageTitleCategorySearch') }]}
              actions={
