...
public class ProductSubmitController {
     ...
     */
    @PostMapping("/initial")
    public BaseApiResponse<SearchResponse<ProductSearchDomainModel>> initial(
            @RequestBody SubmitRequestModel<ProductInitialApplicationModel> request) {
        return BaseApiResponse.success(productService.initialProduct(request));
    }
